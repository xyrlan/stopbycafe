...
const WheatDivider = () => {
  return (
    <div className="flex gap-3 items-center justify-center my-3 select-none">
      <Divider className="bg-default/50 w-7 mr-2 h-px opacity-50" orientation="horizontal" />
      <Image
        alt="Wheat icon"
      ...
      <Image
        ...
        width={30}
      />
      <Divider className="bg-default/50 w-7 ml-2 h-px opacity-50" orientation="horizontal" />
    </div>
  )
}
